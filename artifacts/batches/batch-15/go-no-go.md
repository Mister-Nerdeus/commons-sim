...
- Resource interface and compatibility rule contracts are implemented and tested.
- Module dependency graph contract is implemented and tested.
- Static graph link validation is implemented and tested.
