...
- `node scripts/controls/run-local-validation.mjs --operator codex-batch-15 --include-docker` - PASS, 11 commands including three Docker builds, generated `artifacts/controls/local-validation/latest.json` at `2026-05-05T04:14:08.448Z`
