...
| Required dependencies are treated as valid when unresolved | Medium | Controlled | `ModuleDependencyGraphSchema` rejects required edges targeting unresolved nodes. |
