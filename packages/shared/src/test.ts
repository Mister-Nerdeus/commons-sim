...
import { ScenarioSchema, exportScenarioJsonSchema } from "./scenarioSchema.js";
...
test("ScenarioSchema rejects household mix mismatch", () => {
...
test("exportScenarioJsonSchema returns schema object", () => {
  const schema = exportScenarioJsonSchema();
